...
const RestaurantsPage = () => {
  const shops = getShopsByCategory("Restaurants");
  const allProducts = getAllProductsFromCategory("Restaurants");
    ...
    <div className="min-h-screen bg-light">
      ...
      <div className="container py-6">
        ...
        {viewMode === "products" && allProducts.length === 0 && (
          <div className="text-center py-12">
            <p className="text-secondary text-lg">No menu items found</p>
          </div>
        )}
      </div>
    </div>
